...
export class Database {
  ...
  // here. There is no rotate-in-place — rotation is "create new + revoke
  // old after Grafana side has been updated", to avoid the silent-window
  // failure pattern where Grafana keeps using the old token through a
  // restart.
